...
var RadarRouter_1 = require("./routes/RadarRouter");
var RestService = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                try {
                    ...
                    return [2 /*return*/, this.config.app];
                }
                catch (error) {
    ...
    RestService.prototype.radarRouter = function () {
        return RadarRouter_1.RadarRouter.configure();
    };
    return RestService;
}());
