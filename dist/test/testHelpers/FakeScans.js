...
var FakeData = /** @class */ (function () {
    ...
    FakeData.scans = [
        ...
        {
            enemies: { number: 30, type: "soldier" },
            allies: 8,
        ...
        {
            enemies: { number: 60, type: "soldier" },
            coordinates: { x: 13, y: 15 },
        },
        {
            enemies: { number: 40, type: "soldier" },
        ...
        },
        {
            ...
            allies: 11,
            enemies: { number: 80, type: "soldier" },
        },
    ];
    FakeData.scansWithAllies = [
        {
            enemies: { type: "mech", number: 10 },
            allies: 3,
            coordinates: { y: 35, x: 11 },
    ...
    FakeData.scansOrderedClosestFirst = [
        {
            enemies: { number: 60, type: "soldier" },
            coordinates: { x: 13, y: 15 },
        },
    ...
    FakeData.scansOrderedFurthestFirst = [
        {
            enemies: { number: 1, type: "mech" },
            coordinates: { x: 89, y: 13 },
        },
